<template>
  <div class="container py-5">
    <UserProfileCard
      :initial-user="user"
      :initial-comment-all="userCommentAll"
      :initial-fav-rests="userFavRests"
      :initial-following="userFollowing"
      :initial-follower="userFollower"
      :initial-is-follow="userIsFollow"
      :initial-current-user="currentUser"
    />
    <div class="row">
      <div class="col-sm-4">
        <UserFollowingsCard :initial-following="userFollowing" />
        <UserFollowersCard :initial-followers="userFollower" class="mt-3" />
      </div>
      <div class="col-8">
        <UserCommentsCard :initial-comment-all="userCommentAll" />
        <UserFavoritedRestaurantsCard :initial-fav-rests="userFavRests" class="mt-3" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    fetchdata(userId) {
      console.log("fetchdataid: ", userId);
      ...
      this.userCommentAll = dummyData.profile.Comments;
      this.userFavRests = dummyData.profile.FavoritedRestaurants;
      this.userFollowing = dummyData.profile.Followings;
      this.userFollower = dummyData.profile.Followers;
      this.userIsFollow = dummyData.isFollowed;

      this.currentUser = {
        id: dummyUser.currentUser.id,
        name: dummyUser.currentUser.name,
        isAdmin: dummyUser.currentUser.isAdmin
      };
    }
  }
};
